...
const time = new Command(client, {
    name: 'time',
    description: 'Команда для відображення київського часу',
    ownerOnly: false,
    adminOnly: false
}, async (client, message, args) => {
    const colorLight = '4878CC', colorDark = '000C18';
    const timeString = new Date().toLocaleTimeString('uk-UA', { timeZone: 'Europe/Kiev' });
    const middleHour = 12;
    ...
    message.channel.send({embeds: [{
        title: 'Час',
        description: `Дійсний час на цей момент --> ${timeString}`,
